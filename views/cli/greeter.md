...
This is an introduction on the hello worlds contract for the command line. How to create contracts using a graphical user interface will be tackled on the [next sections](./token).
